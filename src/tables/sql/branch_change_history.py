...
def addBranchChangeHistory(
    ...
    branchChangeHistoryRow = conn.sqlGetInfo('branch_change_history', 'id', f"[branch_id] = '{branchId}' AND [user_id] = '{userId}' AND [date_changed] = '{dateChanged}' AND [changes] = '{changes}'")
