...
sqlTableDefinitions = {
    ...
    "aci_data_change_history": (
        aciDataChangeHistoryFields,
        aciDataChangeHistoryIndexes,
        aciDataChangeHistoryForeignKeys,
    ),
    "address": (addressFields, addressIndexes, addressForeignKeys),
    "agent_certification_test": (
        agentCertificationTestFields,
        agentCertificationTestIndexes,
        agentCertificationTestForeignKeys,
    ),
    "agent_change_history": (
        agentChangeHistoryFields,
        agentChangeHistoryIndexes,
        agentChangeHistoryForeignKeys,
    ),
    "agent": (agentFields, agentIndexes, agentForeignKeys),
    "archive_error_log": (
        archiveErrorLogFields,
        archiveErrorLogIndexes,
        archiveErrorLogForeignKeys,
    ),
    "archive_history": (
        archiveHistoryFields,
        archiveHistoryIndexes,
        archiveHistoryForeignKeys,
    ),
    "assessorial_change_history": (
        assessorialChangeHistoryFields,
        assessorialChangeHistoryIndexes,
        assessorialChangeHistoryForeignKeys,
    ),
    "assessorial": (assessorialFields, assessorialIndexes, assessorialForeignKeys),
    "branch_change_history": (
        branchChangeHistoryFields,
        branchChangeHistoryIndexes,
        branchChangeHistoryForeignKeys,
    ),
    "branch": (branchFields, branchIndexes, branchForeignKeys),
    "certification_test": (
        certificationTestFields,
        certificationTestIndexes,
        certificationTestForeignKeys,
    ),
    "certification_test_change_history": (
        certificationTestChangeHistoryFields,
        certificationTestChangeHistoryIndexes,
        certificationTestChangeHistoryForeignKeys,
    ),
    "certification_test_trainer": (
        certificationTestTrainerFields,
        certificationTestTrainerIndexes,
        certificationTestTrainerForeignKeys,
    ),
    "certification_test_trainer_change_history": (
        certificationTestTrainerChangeHistoryFields,
        certificationTestTrainerChangeHistoryIndexes,
        certificationTestTrainerChangeHistoryForeignKeys,
    ),
    "city_postal_code": (
        cityPostalCodeFields,
        cityPostalCodeIndexes,
        cityPostalCodeForeignKeys,
    ),
    ...
    "company_change_history": (
        companyChangeHistoryFields,
        companyChangeHistoryIndexes,
        companyChangeHistoryForeignKeys,
    ),
    ...
    "customer_change_history": (
        customerChangeHistoryFields,
        customerChangeHistoryIndexes,
        customerChangeHistoryForeignKeys,
    ),
    "customer_default_assessorial": (
        customerDefaultAssessorialFields,
        customerDefaultAssessorialIndexes,
        customerDefaultAssessorialForeignKeys,
    ),
    ...
    "location_change_history": (
        locationChangeHistoryFields,
        locationChangeHistoryIndexes,
        locationChangeHistoryForeignKeys,
    ),
    "location_default_assessorial": (
        locationDefaultAssessorialFields,
        locationDefaultAssessorialIndexes,
        locationDefaultAssessorialForeignKeys,
    ),
    "location": (locationFields, locationIndexes, locationForeignKeys),
    "order_assessorial": (
        orderAssessorialFields,
        orderAssessorialIndexes,
        orderAssessorialForeignKeys,
    ),
    "order_attachment": (
        orderAttachmentFields,
        orderAttachmentIndexes,
        orderAttachmentForeignKeys,
    ),
    "order_change_history": (
        orderChangeHistoryFields,
        orderChangeHistoryIndexes,
        orderChangeHistoryForeignKeys,
    ),
    ...
    "order_status_change_history": (
        orderStatusChangeHistoryFields,
        orderStatusChangeHistoryIndexes,
        orderStatusChangeHistoryForeignKeys,
    ),
    ...
    "overnight_maintenance_history": (
        overnightMaintenanceHistoryFields,
        overnightMaintenanceHistoryIndexes,
        overnightMaintenanceHistoryForeignKeys,
    ),
    "phone": (phoneFields, phoneIndexes, phoneForeignKeys),
    "position_change_history": (
        positionChangeHistoryFields,
        positionChangeHistoryIndexes,
        positionChangeHistoryForeignKeys,
    ),
    "position": (positionFields, positionIndexes, positionForeignKeys),
    "postal_code_region": (
        postalCodeRegionFields,
        postalCodeRegionIndexes,
        postalCodeRegionForeignKeys,
    ),
    ...
    "rate_change_history": (
        rateChangeHistoryFields,
        rateChangeHistoryIndexes,
        rateChangeHistoryForeignKeys,
    ),
    "rate": (rateFields, rateIndexes, rateForeignKeys),
    "region": (regionFields, regionIndexes, regionForeignKeys),
    "special_change_history": (
        specialChangeHistoryFields,
        specialChangeHistoryIndexes,
        specialChangeHistoryForeignKeys,
    ),
    "special": (specialFields, specialIndexes, specialForeignKeys),
    "user_change_history": (
        userChangeHistoryFields,
        userChangeHistoryIndexes,
        userChangeHistoryForeignKeys,
    ),
...
finalAccessConversionDefinitions = {
    ...
    #       TODO: Connect certification system
    ...
    #       TODO: Needs reworking on how the statuses are represented.
    #             Possibly a large list of boolean fields?
    ## "HTC300_G020_T030 Status Update History": convert_HTC300_G020_T030_Status_Update_History,
    #       TODO: Likewise from the last one, status sequences change the IDs
    ## "HTC300_G025_T025 Positions Change History": convert_HTC300_G025_T025_Positions_Change_History,
    #       TODO: Broken along with the general positions table
    ...
    #       TODO: ALL ORDER RELATION TABLES MUST WAIT FOR THE REST OF THE SYSTEM
    #             !!!!
    #             !!!!
    ## "HTC300_G040_T030 Orders Update History": convert_HTC300_G040_T030_Orders_Update_History,
    ## "HTC400_G040_T030 Orders Update History": convert_HTC400_G040_T030_Orders_Update_History,
